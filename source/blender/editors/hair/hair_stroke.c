...
static void hair_edge_comb(HairToolData *data, void *userdata, BMVert *v1, BMVert *v2, float factor, float UNUSED(edge_param))
{
	...
	BKE_sim_debug_data_add_vector(v1->co, strokedir, 1,0,0, "comb", 12345, BM_elem_index_get(v1));
	...
	BKE_sim_debug_data_add_vector(v1->co, edge, 1,1,0, "comb", 3, BM_elem_index_get(v1));
